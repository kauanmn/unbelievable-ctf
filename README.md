...
A curated list of [Capture The Flag](https://en.wikipedia.org/wiki/Capture_the_flag#Computer_security) (CTF) frameworks, libraries, resources, softwares and tutorials. This list aims to help every CTF player to find everything related to CTFs at one place.
...
- [CTF Cafe](https://github.com/CTF-Cafe/CTF_Cafe) - CTF Platform that is cheap, stable, easy to setup and customizable.
...
- [RustScan][https://github.com/rustscan/rustscan] - Lightweight and quick open-source port scanner designed to perform Nmap functions faster.
...
- [Decompiler.com](https://www.decompiler.com/) - C#, Python, Android, Lua, Visual Basic, F# and Java online decompiler.
...
- [Binwalk](https://tools.kali.org/forensics/binwalk) - Searches embedded files/code.
...
- [Strings (Binutils)](https://www.gnu.org/software/binutils/) - Displays printable characters of a file.
